package com.haatehaate.api.nid
...
import com.haatehaate.api.nid.dto.request.NidPersonRequest
...
data class NidApi(
    ...
    fun prepareAutofillBrnRequest(verificationRequest: VerificationRequest): AutofillBrnRequest {
        val birthRegistrationNumber =
            verificationRequest.brn?.birthRegistrationNumber ?: throw IllegalArgumentException("BRN NOT FOUND") // TODO
        val dateOfBirth = verificationRequest.dateOfBirth.toString()
